...
| [agents-catalog.md](agents-catalog.md) | the read-only skills + memory catalog the web sidebar panel renders |
...
| [distill.md](distill.md) | conversation distillation into durable skill or memory artifacts |

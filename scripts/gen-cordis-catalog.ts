...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  agents: 'core.md',
  agentsCatalog: 'agents-catalog.md',
  apiProxy: 'typert.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  AgentsCatalogList: 'catalog wire list is owned by packages/host/agents-catalog/src/types.ts',
  CatalogEntry: 'catalog wire entry is owned by packages/host/agents-catalog/src/types.ts',
  CatalogRef: 'catalog read reference is owned by packages/host/agents-catalog/src/types.ts',
  ...
  DistillResult: 'distillation result is owned by packages/distill/distill/src/types.ts',

...
export class FakeApiClient implements IApiClient {
  ...
  onRewind: (payload: unknown) => Promise<RpcResponse<{ sessionId: SessionId; revertedFiles: boolean }>> = () => Promise.resolve(ok({ sessionId: 'fk-fork' as SessionId, revertedFiles: false }))

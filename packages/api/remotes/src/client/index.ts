...
import gitWorkspaceRemote from '@deepseek-ai/dsh-git-workspace/remote'
...
export type {} from '@deepseek-ai/dsh-agents-catalog/remote'
export type {} from '@deepseek-ai/dsh-git-workspace/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, agentsCatalogRemote, gitWorkspaceRemote,
    ]) {
